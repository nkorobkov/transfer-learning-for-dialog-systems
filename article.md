...
Такая архитектура должна быть достаточно простой, для того чтобы ее можно было разбить на части и транслировать на другой язык, а с другой стороны показывать хорошие результаты.  
В нашей работе мы рассматривали модели основанные на векторах слов или векторах предложений.  
В качестве 
### Результаты

| Модель             | EN   | SV   |   |   |
|--------------------|------|------|---|---|
| fasttext - average | 71.4 | 71.8 |   |   |
| ELMo - average     | 71.6 |      |   |   |
| USE                | 96.6 |      |   |   |

Трансфер W2V-SV(300)  --> USE-EN(512) Линейное преобразование + модель от USE 70%
